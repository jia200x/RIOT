...
#  else
#    ifdef UART_RPL_RPL_MASK
    [UART1_LON_IRQn  ] = isr_uart1_lon,       /* UART1 LON interrupt */
#    endif
...
#  else
#    ifdef UART_RPL_RPL_MASK
    [UART2_LON_IRQn  ] = isr_uart2_lon,       /* UART2 LON interrupt */
#    endif
...
#  else
#    ifdef UART_RPL_RPL_MASK
    [UART3_LON_IRQn  ] = isr_uart3_lon,       /* UART3 LON interrupt */
#    endif
...
#  else
#    ifdef UART_RPL_RPL_MASK
    [UART4_LON_IRQn  ] = isr_uart4_lon,       /* UART4 LON interrupt */
#    endif
...
#  else
#    ifdef UART_RPL_RPL_MASK
    [UART5_LON_IRQn  ] = isr_uart5_lon,       /* UART5 LON interrupt */
#    endif
